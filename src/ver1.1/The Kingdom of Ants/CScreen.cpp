...
int CScreen::Screen_Init()
{
	...
	room_libaray_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_libaray_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_depository_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_depository_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_lab_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_lab_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_training_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_training_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_mushroom_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_mushroom_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_hired_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_hired_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_church_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_church_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_art_init->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	room_art_done->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
	brokenstone->SetColorKey(DDCKEY_SRCBLT | DDCKEY_COLORSPACE, &colorkey);
